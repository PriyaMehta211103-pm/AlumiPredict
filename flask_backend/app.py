...
def predict():
    ...
    if 'model_uts' not in globals() or 'scaler' not in globals():
        return jsonify({'error': 'Machine Learning models are not loaded on the server. Please check server logs.'}), 500
