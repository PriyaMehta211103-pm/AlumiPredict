...
import { FaArrowLeft, FaCog, FaIndustry, FaCheckCircle, FaYoutube } from 'react-icons/fa';
import '../FeaturesPage.css';

const PrecisionManufacturing = () => {
  const fallbackImg = 'https://source.unsplash.com/featured/1200x600?precision,manufacturing,factory';
  return (
      ...
      <div className="feature-detail-content">
        ...
        <section className="feature-detail-section">
          ...
          <div className="video-resources-container">
            <a 
              href="https://www.youtube.com/results?search_query=laser+gauge+wire+diameter+control" 
              target="_blank" 
            ...
            >
              ...
              <div className="video-info">
                ...
                <p>Laser gauging systems explained</p>
              </div>
            </a>
            <a 
              href="https://www.youtube.com/results?search_query=statistical+process+control+manufacturing" 
              target="_blank" 
              rel="noopener noreferrer"
              className="video-resource-card"
            >
              ...
              <div className="video-info">
                ...
                <p>Ensuring quality through statistics</p>
              </div>
            </a>
          </div>
        </section>
