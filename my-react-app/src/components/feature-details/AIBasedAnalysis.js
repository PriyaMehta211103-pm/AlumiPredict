...
import { FaRobot, FaArrowLeft, FaYoutube } from 'react-icons/fa';
import '../FeaturesPage.css';

const AIBasedAnalysis = () => {
  const fallbackImg = 'https://source.unsplash.com/featured/1200x600?ai,neural,manufacturing';
  return (
      ...
      <div className="feature-detail-content">
        ...
        <section className="feature-detail-section">
          ...
          <div className="video-resources-container">
            <a 
              href="https://www.youtube.com/results?search_query=ai+in+metallurgy+analysis" 
              target="_blank" 
            ...
            >
              ...
              <div className="video-info">
                <h4>AI in Metallurgy</h4>
                <p>Explore how AI transforms metal production</p>
              </div>
            </a>
            <a 
              href="https://www.youtube.com/results?search_query=machine+learning+manufacturing+optimization" 
              target="_blank" 
              rel="noopener noreferrer"
              className="video-resource-card"
            >
              ...
              <div className="video-info">
                <h4>ML for Optimization</h4>
                <p>Process optimization using Machine Learning</p>
              </div>
            </a>
          </div>
        </section>
