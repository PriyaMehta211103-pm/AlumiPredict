...
import { FaChartLine, FaArrowLeft, FaDesktop, FaMobileAlt, FaBell, FaYoutube } from 'react-icons/fa';
import '../FeaturesPage.css';

const LiveMonitoring = () => {
  const fallbackImg = 'https://source.unsplash.com/featured/1200x600?dashboard,monitoring,industrial';
  return (
      ...
      <div className="feature-detail-content">
        ...
        <section className="feature-detail-section">
          ...
          <div className="video-resources-container">
            <a 
              href="https://www.youtube.com/results?search_query=industrial+iot+dashboard+monitoring" 
              target="_blank" 
            ...
            >
              ...
              <div className="video-info">
                <h4>IIoT Dashboards</h4>
                <p>Industrial IoT monitoring solutions</p>
              </div>
            </a>
            <a 
              href="https://www.youtube.com/results?search_query=scada+system+explained" 
              target="_blank" 
              rel="noopener noreferrer"
              className="video-resource-card"
            >
